...
public interface EBikeRepository {
   ...
   * @return a CompletableFuture containing the username of the user the bike is assigned to, or
   ...
   *
   * @return a CompletableFuture containing a map of usernames to lists of assigned and available
   *     e-bikes.
   */
